...
<div class="box-body" xmlns="http://www.w3.org/1999/html">
    <div class="col-md-3" style="width: 100%; padding-left: 25%; padding-right: 25%; padding-top: 15px">
        ...
        <#if !not_found??>
            <h2 align="center">Производитель</h2>

            <div class="box box-primary">
                <div class="box-body box-profile" style="box-shadow: 0 1px 1px rgba(0, 0, 0, 0.34); ">
                    <@form.form commandName="brand_form" action="/operator/edit/brands/${brand.id}" acceptCharset="UTF-8" method="post">
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Название</b>
                                <@form.input type="text"  value="${brand.name}" name="name" path="name" class="form-control"/>
                                <p align="center"><@form.errors path="name" cssStyle="color: #ab2020;" /></p>
                            </li>
                        </ul>
                        <button type="submit" class="btn btn-primary btn-block">Обновить данные производителя</button>
                    </@form.form>
                </div><!-- /.box-body -->
            </div><!-- /.box -->
        <#else>
            <h3 align="center">Такого производителя не существует</h3>
        </#if>
    </div>
</div>
</#macro>
...
<@main title="Редактирование производителя"/>